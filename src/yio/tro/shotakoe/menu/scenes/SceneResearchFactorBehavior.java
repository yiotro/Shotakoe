...
import yio.tro.shotakoe.menu.elements.customizable_list.PlotParamsListItem;
...
public class SceneResearchFactorBehavior extends SceneYio {
    ...
    public void resetParamsList() {
        paramsList.clear();
        PlotParameters parameters = new PlotParameters();
        parameters.setMovementType(MovementType.soft_rubber_band);

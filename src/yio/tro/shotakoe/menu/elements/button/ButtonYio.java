...
public class ButtonYio extends InterfaceElement<ButtonYio> {
    ...
    public boolean touchDown() {
        ...
        if (appearFactor.getProgress() < 0.25) return false;

        if (isTouchedBy(currentTouch)) {
            if (silent) return true; // absorb touch without reaction
    ...
    public ButtonYio setConvex(boolean convex) {
        this.convex = convex;
        return this;
    }

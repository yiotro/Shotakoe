...
public class MbSoftRubberBand extends AbstractMoveBehavior{

    public static double x1 = 0.5;
    public static double y1 = 0.61;
    public static double x2 = 0.9;
    public static double y2 = 1.02;
    double k;
    double a;
    double b;
    double c;
